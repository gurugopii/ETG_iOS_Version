...
{
    //if([[self.operationQueue operations] containsObject:objectRequestOperation]){
...
- (void)enqueueBatchOfObjectRequestOperations:(NSArray *)operations
    ...
    //if([[self.operationQueue operations] containsObject:batchedOperation]){

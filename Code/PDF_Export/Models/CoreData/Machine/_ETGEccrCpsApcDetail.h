...
// Make changes to ETGEccrCpsApcDetail.h instead.

#import <CoreData/CoreData.h>


extern const struct ETGEccrCpsApcDetailAttributes {
	...
	__unsafe_unretained NSString *apcAmt;
	__unsafe_unretained NSString *apcFID0;
	__unsafe_unretained NSString *apcGate3;
...
} ETGEccrCpsApcDetailAttributes;

extern const struct ETGEccrCpsApcDetailRelationships {
	__unsafe_unretained NSString *apcForCapex;
	__unsafe_unretained NSString *apcForOpex;
} ETGEccrCpsApcDetailRelationships;

extern const struct ETGEccrCpsApcDetailFetchedProperties {
} ETGEccrCpsApcDetailFetchedProperties;
...
@interface ETGEccrCpsApcDetailID : NSManagedObjectID {}
@end

@interface _ETGEccrCpsApcDetail : NSManagedObject {}
...
@property (nonatomic, strong) NSDecimalNumber* apcAmt;


//- (BOOL)validateApcAmt:(id*)value_ error:(NSError**)error_;




@property (nonatomic, strong) NSDecimalNumber* apcFID0;


//- (BOOL)validateApcFID0:(id*)value_ error:(NSError**)error_;




@property (nonatomic, strong) NSDecimalNumber* apcGate3;


//- (BOOL)validateApcGate3:(id*)value_ error:(NSError**)error_;
...
@property (nonatomic, strong) ETGEccrCpsApc* apcForCapex;

//- (BOOL)validateApcForCapex:(id*)value_ error:(NSError**)error_;




@property (nonatomic, strong) ETGEccrCpsApc* apcForOpex;

//- (BOOL)validateApcForOpex:(id*)value_ error:(NSError**)error_;
...
@interface _ETGEccrCpsApcDetail (CoreDataGeneratedAccessors)

@end

@interface _ETGEccrCpsApcDetail (CoreDataGeneratedPrimitiveAccessors)
...
- (NSDecimalNumber*)primitiveApcAmt;
- (void)setPrimitiveApcAmt:(NSDecimalNumber*)value;




- (NSDecimalNumber*)primitiveApcFID0;
- (void)setPrimitiveApcFID0:(NSDecimalNumber*)value;




- (NSDecimalNumber*)primitiveApcGate3;
- (void)setPrimitiveApcGate3:(NSDecimalNumber*)value;
...
- (ETGEccrCpsApc*)primitiveApcForCapex;
- (void)setPrimitiveApcForCapex:(ETGEccrCpsApc*)value;



- (ETGEccrCpsApc*)primitiveApcForOpex;
- (void)setPrimitiveApcForOpex:(ETGEccrCpsApc*)value;

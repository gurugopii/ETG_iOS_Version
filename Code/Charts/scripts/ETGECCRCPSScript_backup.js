        	...
        	var reportTopInfo = {};
        	reportTopInfo[APC_NAME]={status:"", currency:""};
        	reportTopInfo[FDP_NAME]={status:"", currency:""};
        	reportTopInfo[CPB_NAME]={status:"", currency:""};
        	reportTopInfo[WPB_NAME]={status:"", currency:""};
        	reportTopInfo[AFE_NAME]={status:"", currency:""};
...
window.swiper = new Swipe(elem, {
        	...
        	function populateCps(cpsData) {
				...
				//get active tab 
				var tabs = $('#cpsTabs'), activeTab = tabs.find('li.active'), activeTabText = activeTab.find('a.tabSwitch').text();
        		...
        		cpsData.apc.apcTableDataCapex.sort(function (a, b) { return a.rowSequence-b.rowSequence;});
        		cpsData.apc.apcTableDataOpex.sort(function (a, b) {return a.rowSequence-b.rowSequence;});                                  
				cpsData.fdp.fdpTableDataCapex.sort(function (a, b) {return a.rowSequence-b.rowSequence;});   
				cpsData.fdp.fdpTableDataOpex.sort(function (a, b) {return a.rowSequence-b.rowSequence;});   
				cpsData.cpb.cpbTableDataCapex.sort(function (a, b) {return a.rowSequence-b.rowSequence;});   
				cpsData.cpb.cpbTableDataOpex.sort(function (a, b) {return a.rowSequence-b.rowSequence;});   
				cpsData.wpb.wpbTableDataCapex.sort(function (a, b) {return a.rowSequence-b.rowSequence;});   
				cpsData.wpb.wpbTableDataOpex.sort(function (a, b) {return a.rowSequence-b.rowSequence;});   
				cpsData.afe.afeTableDataCapex.sort(function (a, b) {return a.rowSequence-b.rowSequence;});   
				cpsData.afe.afeTableDataOpex.sort(function (a, b) {return a.rowSequence-b.rowSequence;});   
...
//    });
       ...
       console.log('ready tab' + ' ' + activeTabName);
       
       console.log('ready active pos' + ' ' + activeTabName);
